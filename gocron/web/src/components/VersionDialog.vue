...
<template>
  <dialog :id="id" class="modal modal-bottom sm:modal-middle">
    <div class="modal-box">
      ...
      <a href="/api/docs" class="btn btn-primary w-full mt-10">
        <svg class="size-8" width="128" height="128" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
          <path
          ...
          />
          <path
            style="fill: #4c5930; fill-opacity: 1; fill-rule: nonzero; stroke: none"
          ...
          />
          <path
            style="fill: #68a338; fill-opacity: 1; fill-rule: nonzero; stroke: none"
